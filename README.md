...
We have organized 4 groups, each with a "lead" to coordinate the efforts of contributing to the project or repository. There are different projects based upon different technologies, whether you are an experienced practioner of PowerShell, or want to learn Ansible, there is a project for you to join!
...
- **Wednesday 11/30** -    [TBD1](challenges/1) with [Matthew Brender](https://twitter.com/mjbrender)
- **Wednesday 12/7** -  [Setting up Windows](challenges/2) with [Jonathan Frappier](https://twitter.com/jfrappier)
- **Wednesday 12/14** -   [Setting up OSX](challenges/3) with [Timmy Carr](https://twitter.com/timmycarr)
- **Wednesday 12/21** -     [Git Basics - Clone, Add, Commit, & Push](challenges/4) with [Anthony Elizondo](https://twitter.com/complex)
...
**Your challenge**:
* Update the README.md file for your **every single day** with some new feature or functionality that your team created. This is analogus to maintaining project documentation
