...
1. [Overview](#overview)
2. [vBrownBag Schedule](#vbrownbag-schedule)
3. [The Teams](#the-teams)
4. [The Standard Challenge](#the-standard-challenge)
5. [Commit to Your Skill Level](#commit-to-your-skill-level)
    * [Beginner](#beginner)
...
## Team Chef with [Jesse Anderson](https://twitter.com/sockeyes51)

* [Deploying LAMP Stack to Docker Containers with Chef](https://github.com/jessecanderson/commitmas-2016-chef-project)
...
## Team Puppet with [Rob Nelson](https://twitter.com/rnelson0)
...
## Team Python  with [Matt Oswalt](https://twitter.com/mierdin)

* [pybluedot](https://github.com/commitmas/pybluedot), a Python project exploring NASA's public APIs
